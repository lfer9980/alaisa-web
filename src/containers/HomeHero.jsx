	...
	return (
		<section className='hero wrapper section' id='hero'>
			...
			<div className='hero__parrafo--button'>
				<p>Me enseñaron a identificar características en los personas con <strong>COVID-19</strong> para saber si los pacientes tienen más posibilidades de darse de alta o de fallecer por esta enfermedad.</p>
			</div>
			<ButtonGreen text ="Comienza aquí" /> 
		</section>
	);
}
